...
define view entity ZC_BOOKING_268_014
  ...
  
{
  key BookingUUID,
      ...
      /* Associations */
      _BookingStatus,
      _BookingSupplement : redirected to composition child ZC_BKSUPPL_268_014,
      _Carrier,
      _Connection,
      _Customer,
      _Travel            : redirected to parent ZC_TRAVEL_268_014
}
